...
/** What each variant does to the deck, in the few words that fit under three buttons. */
...
/**
 * The three-way boundary gate. Buttons rather than a slider: each click rebuilds both track geometries
...
export function DebugVariant( { value }: { value: BoundaryVariant } ) {
    const options: BoundaryVariant[] = [ 'A', 'B', 'C' ];
