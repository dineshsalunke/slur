...
export const NUMBER_TUNABLES = {
    ...
    'Fracture.gap': { value: 0.12, min: 0, max: 0.8, step: 0.01, rebuild: false },
    'Fracture.glow': { value: 6, min: 0, max: 40, step: 0.1, rebuild: false },
    ...
    'Break.flare': { value: 3, min: 0, max: 12, step: 0.1, rebuild: false },
    'Break.flashLife': { value: 0.25, min: 0.05, max: 1.5, step: 0.01, rebuild: false },
    'Break.flashSize': { value: 1.5, min: 0, max: 5, step: 0.05, rebuild: false },
    'Break.flashBright': { value: 4, min: 0, max: 20, step: 0.1, rebuild: false },
