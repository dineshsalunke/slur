...
export const NUMBER_TUNABLES = {
    ...
    'Break.speed': { value: 16, min: 0, max: 60, step: 0.5, rebuild: false },
    'Break.up': { value: 5, min: 0, max: 40, step: 0.5, rebuild: false },
    'Break.carry': { value: 0.35, min: 0, max: 1, step: 0.01, rebuild: false },
    'Break.spin': { value: 1.6, min: 0, max: 12, step: 0.05, rebuild: false },
    'Break.gravity': { value: 46, min: 5, max: 150, step: 1, rebuild: false },
    'Break.bounce': { value: 0.22, min: 0, max: 0.9, step: 0.01, rebuild: false },
    'Break.friction': { value: 0.6, min: 0, max: 1.5, step: 0.01, rebuild: false },
    'Break.spinDrag': { value: 0.25, min: 0, max: 4, step: 0.05, rebuild: false },
    'Break.flare': { value: 0.6, min: 0, max: 12, step: 0.1, rebuild: false },
    'Break.cool': { value: 0.7, min: 0.1, max: 6, step: 0.05, rebuild: false },
    ...
    'Meteor.shake': { value: 0.55, min: 0, max: 2, step: 0.01, rebuild: false },
    'Meteor.ember': { value: 1.4, min: 0, max: 20, step: 0.1, rebuild: false },
    'Meteor.cool': { value: 3.5, min: 0.3, max: 12, step: 0.1, rebuild: false },
