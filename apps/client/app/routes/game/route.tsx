...
// id — a cold deep-link / stale id → back to the landing — then waits for the server TrackDescriptor to
// decode so NetCanvas builds a track matching the server from its first render.
