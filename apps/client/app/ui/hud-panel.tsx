...
// held-power, confirm) is one of these. LOOK ONLY: positioning and padding come from the caller's className
// (each anchor differs, and a couple are static-in-a-grid), so nothing here can conflict with them.
