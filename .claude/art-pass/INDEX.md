...
| 2 | **Track** — floor material, glowing edge rail, gaps, gap rims | [`02-track/`](02-track/README.md) | **IN PROGRESS — the review frame is honest (#131); the art is not built.** Eight decisions of-record in [`02-track/README.md` §7](02-track/README.md); **D6–D8 were taken after #131** and re-shape what remains: the track boards govern seam density (board 17 is atmosphere), the emitter array is built **before** the floor's finish is judged, and board 25's wear lives in the D2 shader patch in **world space**, not a second tiled map. Four slices left — swap → light → surface+wear → gaps — in [`02-track/LANE-BRIEF.md`](02-track/LANE-BRIEF.md) §3 |
