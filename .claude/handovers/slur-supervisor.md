...
|---|---|---|---|---|
| workerone | w2P:pD | #253 pipeline: map/mine/variants/pilot/record/cli → first real bundle in `apps/client/.songs/lab/` | building; UNCOMMITTED: song-lab/bundle.ts (M), map.ts, mine.ts, pilot.ts, record.ts, song-lab-cli.ts, variants.ts | apps/client/song-lab/**, score/compose.ts + test, score/emit.ts + test, client package.json + vitest.config.ts (1 line each) |
