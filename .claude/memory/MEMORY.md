...
- [Agent headless Chrome starves the owner](agent-headless-chrome-starves-the-owner.md) — `--force-device-scale-factor=1 --mute-audio`, kill after measuring; check `ps` before blaming code for fps
