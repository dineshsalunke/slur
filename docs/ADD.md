...
- **No atmosphere:** flat `#05060a` void — no fog, skybox/gradient, or real starfield (cuberun, our anchor, leans on fog + a ~10k-star field + a galaxy skybox for depth). *(STALE 2026-09-22 — the scene now carries a nebula backdrop, a drei starfield and linear scene fog (`scene/scene-fog.tsx`, issue #210, `Fog.*` in the tuning panel). Since 2026-09-23 (#224) the fog is black and starts at 700u, ending at the camera far plane of 1000u. It exists only to cover the streaming edge `AHEAD = 900`; nothing inside 700u is fogged. The earlier horizon-tinted fog at 40–420u greyed the far monoliths while the sky and rocks behind them stayed clear, which read as haze in a vacuum.)*
