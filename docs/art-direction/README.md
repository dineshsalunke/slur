...
| Vehicles — Split Crown | [Concept sheet](vehicles/split-crown/concept-sheet.png) | Selected hero/view sheet; replaces the C3 variations board in this set. |
...
15 images total, including the approved cruise and action lighting companions. Selection confirms the artwork set; generated dimensions and incidental details do not override gameplay contracts or certify production models.
