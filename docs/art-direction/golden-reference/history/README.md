...
| 17 board | [Cold-undertone draft](boards/17_golden_reference_cold_undertone_DRAFT.png) / [FINAL](../17_golden_reference_FINAL.png) | [Prompt](boards/17_golden_reference_PROMPT.txt) | 16; faint cold tint and tile refinement; FINAL approved |
