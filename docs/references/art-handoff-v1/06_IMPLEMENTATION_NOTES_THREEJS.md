...
- Keep bloom restrained; readability should survive with bloom disabled.
...
- intact mesh + emissive fracture mask + destroyed-state disappearance
- intact mesh → pre-fractured replacement mesh on hit/break
